...
availability = {
    ...
    "Bala": ["Saturday 06:00", "Sunday 10:45", "Sunday 23:55"],
    "Dheeraj": ["Saturday 11:00", "Sunday 11:00", "Sunday 12:00"],
    "Poojitha": ["Saturday 12:00", "Sunday 12:00", "Sunday 13:00"],
}
...
def find_common_slots(utc_availability):
    ...
    common_slots = set.intersection(*all_people_slots)
